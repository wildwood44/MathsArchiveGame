...
public class Puzzle_10 extends Puzzle {
	GamePanel gp;
	int question = 1;
	int bonus = 0;
	...
	public void generatePuzzle() {
		...
		for(int i = 0; i < 4; i++) {
			values[i] = (Math.round(Math.random()*9)+1);
		}
	...
	public void drawPuzzle(Graphics2D g2) {
		...
		BufferedImage pyramid = setup("/res/objects/pyramid-1", gp.tileSize*8, gp.tileSize*6);
