...
public class Obj_Calculator_Button_Rad extends Object {
	GamePanel gp;
	...
	public Obj_Calculator_Button_Rad(GamePanel gp) {
		super(gp);
		this.gp = gp;
		this.enId = objId;
		id = -1;
	...
	public void interact() {
		...
		Obj_Calculator_Button_Rad btn = (Obj_Calculator_Button_Rad) gp.obj[20][3];
		if(cal.stage == 0) {
			cal.reset();
		} else if(btnId==0) {
			if(btn.btnId == 1) {
