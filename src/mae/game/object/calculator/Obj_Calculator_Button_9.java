...
public class Obj_Calculator_Button_9 extends Object {
	GamePanel gp;
	...
	public Obj_Calculator_Button_9(GamePanel gp) {
		super(gp);
		this.gp = gp;
		this.enId = objId;
		id = -1;
	...
	public void interact() {
		...
		Obj_Calculator_Button_9 btn = (Obj_Calculator_Button_9) gp.obj[20][3];
		if(cal.stage == 0) {
			cal.reset();
		} else if(btnId==0) {
			if(btn.btnId == 1) {
