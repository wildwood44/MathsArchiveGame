...
public class Obj_Calculator_Button_Up extends Object {
	GamePanel gp;
	public final static int objId = 21;
	public int btnId;
	...
	public Obj_Calculator_Button_Up(GamePanel gp) {
		super(gp);
		this.gp = gp;
		this.enId = objId;
		id = -1;
	...
	public void interact() {
		...
		Obj_Calculator_Button_Num btn = (Obj_Calculator_Button_Num) gp.obj[20][3];
		if(cal.stage == 0) {
			cal.reset();
		} else if(btnId==0) {
			if(btn.btnId == 1) {
