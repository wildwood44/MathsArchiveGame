...
public class Obj_Computer_Seccurity extends Object {
	GamePanel gp;
	...
	public Obj_Computer_Seccurity(GamePanel gp) {
		super(gp);
		this.gp = gp;
		this.enId = objId;
		id = -1;
	...
	public void setDialogue() {
		dialogue[0][0] = "Asset has escapes calling security!";
		dialogue[0][1] = "#Security drones: On Order#";
		dialogue[0][2] = "Bugger...";
	}
}
