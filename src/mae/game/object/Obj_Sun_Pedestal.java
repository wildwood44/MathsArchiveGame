...
public class Obj_Sun_Pedestal extends Object {
	GamePanel gp;
	public final static int objId = 9;
	public boolean open = false;
	public int input = 0;
	public boolean correct = true;

	public Obj_Sun_Pedestal(GamePanel gp) {
		super(gp);
		this.gp = gp;
		this.enId = objId;
		id = -1;
	...
	public void getImage() {
		idle1 = setup("/res/objects/help_pedestal1", gp.tileSize, gp.tileSize);
		idle2 = setup("/res/objects/help_pedestal2", gp.tileSize, gp.tileSize);
	}
